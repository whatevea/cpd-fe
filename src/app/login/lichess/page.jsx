...
export default function Page() {
  ...
  useEffect(() => {
    const verify_auth = async () => {
      ...
      try {
        const verify_url = "/api/login_lichess/verify_auth";
        ...
        console.error("Lichess auth error:", error);
        setLoadingState("error");
      }
    };
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg max-w-md w-full text-center">
        ...
        {loadingState === "verifying" && (
          <>
            ...
            <p className="text-xl">Authenticating with Lichess...</p>
            <p className="text-sm text-gray-400 mt-2">
              Please wait while we verify your Lichess credentials
            </p>
          </>
        )}
        ...
        {loadingState === "success" && (
          <>
            ...
            <p className="text-xl text-green-400">Lichess Login Successful!</p>
            <p className="text-sm text-gray-400 mt-2">
        ...
        {loadingState === "error" && (
          <>
            ...
            <p className="text-xl text-red-400">Lichess Authentication Failed</p>
            <p className="text-sm text-gray-400 mt-2">
              Unable to authenticate with Lichess. Please try again.
            </p>
            <button
