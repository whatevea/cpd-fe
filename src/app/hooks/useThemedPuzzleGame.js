...
import {
  getRandomPuzzleOffline,
  getRandomPuzzleOfflineByTheme,
} from "@/app/utils/offline_puzzle";
...
export const useThemedPuzzleGame = ({ theme } = {}) => {
  ...
  const loadPuzzle = useCallback(async () => {
    ...
    try {
      const offlinePuzzle = theme
        ? await getRandomPuzzleOfflineByTheme(theme)
        : await getRandomPuzzleOffline();
      if (!offlinePuzzle) {
